package rcoem.com.ankush.DynamicGridViewDemo;

import java.util.ArrayList;

import rcoem.com.ankush.ccdyngridview.*;
...
public class DynamicGridViewDemo extends Activity implements   View.OnClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		global_panel.setBackgroundDrawable(getResources().getDrawable( R.drawable.bc));
